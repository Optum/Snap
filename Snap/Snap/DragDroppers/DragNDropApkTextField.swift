...
class DragNDropApkTextField: NSTextField {

    var filePath: String?
    let expectedExt = ["apk"]  //file extensions allowed for Drag&Drop (example: "jpg","png","docx", etc..)
    var bgColor: CGColor?
    var del: selectedAPK?
    ...
    override func performDragOperation(_ sender: NSDraggingInfo) -> Bool {
        ...
        del?.selectedAPK(path)

        return true
    }
}

protocol selectedAPK {
