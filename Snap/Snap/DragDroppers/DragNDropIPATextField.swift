...
class DragNDropIPATextField: NSTextField {

    var filePath: String?
    let expectedExt = ["ipa"]  //file extensions allowed for Drag&Drop (example: "jpg","png","docx", etc..)
    var bgColor: CGColor?
    var del: selectedIPA?
    ...
    override func performDragOperation(_ sender: NSDraggingInfo) -> Bool {
        ...
        del?.selectedIPA(path)

        return true
    }
}

protocol selectedIPA {
